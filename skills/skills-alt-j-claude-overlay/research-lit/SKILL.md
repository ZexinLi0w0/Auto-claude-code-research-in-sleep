...
- **REVIEWER_BACKEND = `gemini-review`** — Default for Alt J: Gemini via the local `gemini-review` MCP bridge. (This skill itself does not invoke a reviewer; the constant is kept for downstream skills that read it.)
